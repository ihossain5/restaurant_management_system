                ...
                <div class="modal-body">
                    <form class="restaurantAddForm" method="POST" enctype="multipart/form-data"> @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" name="logo" class="custom-file-input dropify"
                                    ...
                                    data-allowed-file-extensions='["jpg", "svg", "png"]' data-max-file-size="0.6M" data-height="80">
                            </div>
                            <label id="logo-error" class="error mt-2 text-danger" for="logo"></label>
                        </div>
                        ...
                        <div class="row asset_row  asset_div0">
                            ...
                            <div class="col-md-2">
                                <div class=" remove_row0" onclick="remove(0)">
                                    <i class="mdi mdi-delete close_icon_add_form"></i>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <form class="updaterestaurantForm" method="POST"> @csrf
                        ...
                        <div class="row">
                            <div class="col-md-7"></div>
                            <div class="col-md-2">
                              <button class="btn btn-primary add_row_btn" onclick="addRowEdit()" type="button"><i class="fa fa-plus"></i> Add</button>
                            </div>
                        </div>
    ...
    <script type='text/javascript'>
                        ...
                        $.each(response.data.assets, function(key, value) {
                            $('#append_restaurant_assets').append(
                                ` <div class="row area_row_edit  asset_div_edit${key}">
                                    <input type="hidden" name="asset[${key}][asset_restaurant_id]" value="${value.pivot.asset_restaurant_id}">
                                    <div class="col-md-5">
                                            <div class="form-group">
                                                <select name="asset[${key}][section]" class="form-control section-select-box" id="section${key}">
                                                    <option value="">Select Section</option>
                                                    <option value="home" ${value.pivot.section== 'home' ? 'selected' : ''}>Home</option>
                                                    <option value="about_us" ${value.pivot.section== 'about_us' ? 'selected' : ''}>About Us</option>
                                                    <option value="menu" ${value.pivot.section== 'menu' ? 'selected' : ''}>Menu</option>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                <div class="custom-file url${key}">
                                                    <input type="file" name="asset[${key}][asset]" id="urla${key}"
                                                                ...
                                                                data-height="25" data-errors-position="outside"
        ...
        function addRow() {
            ...
            if (asset === "" ||section === '') {
                ...
                $(".section_error_msg" + i).show();

            } else {
                ++i;
                var new_i = i - 1;
                $(".error_msg" + new_i).hide();
                $(".section_error_msg" + new_i).hide();
                $(".asset_row:last")
                    .after(` 
                    <div class="row asset_row test_row asset_div${i}">                         
                        <div class="col-md-5">
                                <div class="form-group">
        ...
        function addRowEdit() {
            ...
            if (area_edit === "") {
                ...
                $(".area_row_edit:last")
                    .after(` 
                    <div class="row area_row_edit  asset_div_edit${i}">   
                        <div class="col-md-5">
                            <div class="form-group">
                                <select name="new_asset[${i}][section]" class="form-control section-select-box" id="section${i}">
                                    <option value="">Select Section</option>
                                    <option value="home">Home</option>
                                    <option value="about_us" >About Us</option>
                                    <option value="menu" >Menu</option>
