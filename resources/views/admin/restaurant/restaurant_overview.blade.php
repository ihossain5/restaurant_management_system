                ...
                <div class="col-12 col-md-6 col-lg-3">
                    ...
                    <div class="card m-b-30 card-body dashboardCard orderCard activeOrderCard">
                        <div class="secondCardContent ">
                            ...
                            <div>
                                <h1 class="orderValue new_orders" data-order="{{ $new_orders }}">{{ $new_orders }}</h1>
                                <h5>New Orders</h5>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row pt-5">
                <div class="col-12 col-md-6 col-lg-3">
                    ...
                    <div class="card m-b-30 card-body dashboardCard">
                        <div class="secondCardContent">
                            <div>
                                <img src="{{asset('backend/assets/icons/complete.svg')}}" alt="">
                            </div>
                            <div>
                                <h1 class="completedOrders">{{ $completedOrders}}</h1>
                                <h5>Completed</h5>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    ...
                    <div class="card m-b-30 card-body dashboardCard">
                        <div class="secondCardContent">
                            <div>
                                <img src="{{asset('backend/assets/icons/gridicons_cross-circle.svg')}}" alt="">
                            </div>
                            <div>
                                <h1 class="cancelledOrders">{{ $cancelledOrders}}</h1>
                                <h5>Cancelled</h5>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    ...
                    <div class="card m-b-30 card-body dashboardCard">
                        <div class="secondCardContent">
                            <div>
                                <img src="{{asset('backend/assets/icons/wpf_coins.svg')}}" alt="">
                            </div>
                            <div>
                                <h1 class="total_revenue">{{ $total_revenue}}</h1>
                                <h5>Revenue</h5>
                            </div>
                        </div>
                    </div>
...
@section('pageScripts')
    <script>
        ...
        var config = {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success === true) {
                        ...
                        $('.new_orders').attr('data-order',response.data.new_orders);

                        var today_order_url = '{{ route('orders.today', ':id') }}';                      
                        today_order_url = today_order_url.replace(':id', response.data.id);
                        $('.todaysOrderUrl').attr("href", today_order_url);
          ...
          // Card Color change when order active
