                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active p-3" id="home-1" role="tabpanel">
                                                    <div class="ms-panel-body">
                                                        <form method="POST" action="{{ route(Auth::user()->is_manager == 1 ? 'manager.profile.update' : 'profile.update') }}"
                                                            ...
                                                            <div class="d-flex justify-content-center">
                                                                <button class="btn btn-purple mt-4 d-block"
                                                ...
                                                <div class="tab-pane p-3" id="profile-1" role="tabpanel">
                                                    <div class="ms-panel-body">
                                                        <form method="POST" action="{{ route(Auth::user()->is_manager == 1 ? 'manager.password.update' : 'password.update' ) }}"
                                                            id="changePassword"> @csrf
