                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-signIn" role="tabpanel"
                                ...
                                <div class="row formInput">
                                    <form id="passwordResetForm" method="POST" action="{{route('customer.reset.password.form')}}">@csrf
                                        <div class="col-12 text-start">
                                            <input type="hidden" name="token" value="{{ $customer->token }}">
                                            <input class="form-control" name="email" type="text" placeholder="Your Email" value="{{$customer->email}}">
                                        </div>
                                       ...
                                       <div class="text-start forgot-password">
                                        ...
                                        <div class="col-12 text-center">
                                            <button type="submit" class="outlineBtn rounded-pill">Reset Password</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
